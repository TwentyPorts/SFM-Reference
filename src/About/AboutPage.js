  ...
  return (
    <div className="about-page">
      <div className="about-page-container">
        ...
        <br />
        SFM Reference is a categorized repository of artwork made using Source
        Filmmaker, meant to serve as a point of reference or inspiration for SFM
        artists. More informally, it's a personal project for me to learn about
        ...
        Anyar#0380 on Discord, or make a PR/issue on the GitHub repo linked
        below. If you're adding new images, please make sure that all images are
        compressed (i.e. no image should be larger than 15 MB), properly
        attributed and categorized.
        <br />
        <br />
        This repo is hosted on{" "}
        <a href="https://github.com/TwentyPorts/SFM-Reference">GitHub</a>.
      </div>
    </div>
  );
};
